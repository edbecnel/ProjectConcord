...
- [PCON-0003 — Governed pause, continuation, and resume](../Architecture/PCON-0003-Governed-Pause-Continuation-and-Resume.md) — post-closeout discovery (Proposed); [AWI-0002](../Architecture/Watch_Items/AWI-0002-Governed-Pause-Continuation-and-Resume.md); interim [PCR-0001](../Development/PCR-0001-Project-Continuation-and-Pause-Record.md)
- [PCON-0004 — Primary orchestration and external engineering/AI integration](../Architecture/PCON-0004-Primary-Orchestration-UI-and-External-Engineering-AI-Integration.md) — post-closeout discovery (Proposed); [AWI-0003](../Architecture/Watch_Items/AWI-0003-Primary-Orchestration-and-External-AI-Engineering-Tool-Integration.md)
